...
mod tests {
    ...
    fn test_u8() {
        ...
        let d_result = u8::bin_deserialise_from(buffer.as_slice());
    ...
    fn test_u16() {
        ...
        let d_result = u16::bin_deserialise_from(buffer.as_slice());
    ...
    fn test_u32() {
        ...
        let d_result = u32::bin_deserialise_from(buffer.as_slice());
    ...
    fn test_u128() {
        ...
        let d_result = u128::bin_deserialise_from(buffer.as_slice());
    ...
    fn test_timestamp() {
        ...
        let d_time = DateTime::<Local>::bin_deserialise_from(buffer.as_slice());
    ...
    fn test_timestamp_list() {
        ...
        let d_wrap = NLengthVector::<u16, 1>::bin_deserialise_from(buffer.as_slice());
    ...
    fn test_array() {
        ...
        let d_array = <[u8; 7]>::bin_deserialise_from(buffer.as_slice());
    ...
    fn test_ipv4() {
        ...
        let d_ipv4 = Ipv4Addr::bin_deserialise_from(buffer.as_slice());
    ...
    fn test_ipv6() {
        ...
        let d_ipv6 = Ipv6Addr::bin_deserialise_from(buffer.as_slice());
    ...
    fn test_ipaddr() {
        ...
        let d_ip = IpAddr::bin_deserialise_from(buffer.as_slice());
    ...
    fn test_string() {
        ...
        let d_string = String::bin_deserialise_from(buffer.as_slice());
